define(["angular"],function(){
	...
	.provider("modalService",function(){
		var modalServiceProvider = {
			options:{
				templateUrl:"/activity/res/framework/angularUtils/bootstrapModule/tpls/myModalContent.html",
			...
			loadOptions:{
				templateUrl:"/activity/res/framework/angularUtils/bootstrapModule/tpls/loadModalContent.html",
				resolve:{
					options:function(){
						return {
						}
